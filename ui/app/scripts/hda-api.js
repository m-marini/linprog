...
var supplierOrder = [ 'campo', 'mangimificio', 'gallina', 'mucca', 'maiale',
		'panetteria', 'caseificio', 'zuccherificio', 'stufa_popcorn',
		'barbeque', 'forno_pasticci', 'melo' ];
var productOrder = [ 'grano', 'mais', 'soia', 'canna_zucchero', 'carote',
		...
		'latte', 'panna', 'burro', 'formaggio', 'zucchero_canna', 'zucchero',
		'pancake', 'pancetta_uova', 'popcorn', 'pancetta', 'pasticcio_carote',
		'pasticcio_zucca', 'mela'
